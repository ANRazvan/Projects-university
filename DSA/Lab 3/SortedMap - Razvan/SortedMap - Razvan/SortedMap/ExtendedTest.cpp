...
void testUpdate() {
	SortedMap sm1 = SortedMap(increasing);
	SortedMap sm2 = SortedMap(increasing);
	sm1.add(2, 3);
	sm1.add(3, 5);
	sm1.add(7, 10);
	sm1.add(4, 5);
	...
	sm2.add(4, 6);
	sm2.add(7, 11);
	int number = sm1.updateValues(sm2);
	assert(sm1.search(2) == 3);
	assert(sm1.search(3) == 4);
	assert(sm1.search(7) == 11);
	assert(sm1.search(4) == 6);
	assert(sm1.search(8) == 20);
	assert(number == 3);

	SortedMap sm3(decreasing);
	SortedMap sm4(decreasing);
	sm3.add(2, 3);
	sm3.add(3, 5);
	sm3.add(7, 10);
	sm3.add(4, 5);
	...
	sm4.add(4, 6);
	sm4.add(7, 11);
	int number = sm3.updateValues(sm4);
	assert(sm3.search(2) == 3);
	assert(sm3.search(3) == 4);
	assert(sm3.search(7) == 11);
	assert(sm3.search(4) == 6);
	assert(sm3.search(8) == 20);
	assert(number == 3);
